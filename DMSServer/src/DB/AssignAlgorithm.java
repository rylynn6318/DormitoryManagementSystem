...
public class AssignAlgorithm 
{
	...
	{
		String sql = "SELECT A.학번 FROM Prototype.신청 A  INNER JOIN Prototype.서류 B ON A.학번 = B.학번 WHERE A.납부여부 = 'Y' AND A.합격여부 = 'Y' AND (B.서류유형 = 'MEDICAL_REPORT' AND B.유효여부 = 'Y')";
