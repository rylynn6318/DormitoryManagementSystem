<<<<<<< HEAD:DMSServer/src/logic/ScheduleCheck.java
package logic;
...
public class ScheduleCheck {
	...
	public static void check(byte page) throws ClassNotFoundException, SQLException
	{
		// 지금 DB가 datetime타입이 아니라 시분초설정이 오전9시로 고정되어있음 ㅇㅇ 그거 수정하고 다시 검사필요
		...
		String sql = "SELECT 시작일, 종료일 FROM " + DB_NAME + ".스케쥴  WHERE (`스케쥴 할일 코드_ID` ="+String.valueOf((int)page) +")";
...
>>>>>>> 747304a2197bf463c5cc307205030434e3caf072:DMSServer/src/ScheduleCheck.java
